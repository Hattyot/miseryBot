    ...
    function info() {
        channel.fetchMessage("536218699049336863").then(message => {
            ...
            // .setThumbnail("https://user-images.githubusercontent.com/39061940/50972501-77bb1780-14ef-11e9-9712-fcacf98014ad.png")
                ...
                .addField("**2. Do you have complaints or compliments for a staff member?**", "Fill out this form: https://goo.gl/7L5JTo\n** **")
                .addField("**3. Do you have a suggestion for the server?**", "Fill out this form: https://goo.gl/7L5JTo\n** **")
