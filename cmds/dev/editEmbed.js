    ...
    function rules() {
        channel.fetchMessage("536196178136662016").then(message => {
            let newEmbed = new Discord.RichEmbed()
                ...
                .addField("**10. Keep controversial topics out of main chats and voice channels**", "When bringing up Subjects to discuss, we are against matters such as heavy illegal drug usage (Cocain and so on as an example) and we promote Life and Love, so we dont appreciate suicidle subjects in main chats or Voice chats, we have help channels for those in need, or staff on hand whop are qualified handle life matters for the most part.")
